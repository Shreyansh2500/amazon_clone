...
const Header = () => {
  ...
  return (
    <div className="w-full sticky top-0 z-50">
        <div className="w-full bg-amazon_blue text-white px-2 py-3 flex items-center gap-4">
          {/* ============ Image Start here ============== */}
          ...
          <div className="flex items-start justify-center headerHover relative">
            ...
            <p className="text-xs font-semibold mt-3 text-whiteText">
              Cart <span className="absolute text-xs -top-1 left-6 font-semibold p-1 h-4 
                  bg-[#f3a847] text-amazon_blue rounded-full flex items-center justify-center">0</span>
            </p>
          </div>
          {/* ============ Cart end here ================= */}
        </div>
